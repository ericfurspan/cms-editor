...
const PrivacyPolicy = () => (
  <Container>
    ...
    <div className="text-white">
      ...
      <p>
        We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy is maintained by the
        <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/">&nbsp;&nbsp;Free Privacy Policy Generator</a>
        .
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            {' '}
            (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to cmseditor.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          {' '}
          refers to cmseditor, accessible from https://cmseditor.netlify.app
        </li>
        {' '}
        <li>
      ...
      <ul>
        <li>By email: admin@quanda.dev</li>
      </ul>
    </div>
    <PublicFooter />
  </Container>
