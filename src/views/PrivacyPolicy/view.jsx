...
const PrivacyPolicy = () => (
  <div className="pb-2">
    <Container className="text-dark">
      <h1 className="mt-2 mb-2">Privacy Policy</h1>
      <p>
      ...
      <p>
        ...
        This Privacy Policy is maintained by the
      ...
      <ul>
        ...
        <li>
          <strong>Website</strong> refers to cmseditor, accessible from https://cms.quanda.dev
        </li>{' '}
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          Social Media Service may see You name, profile, pictures and description of Your
      ...
      <span>By email: admin@quanda.dev</span>
    </Container>
  </div>
);
