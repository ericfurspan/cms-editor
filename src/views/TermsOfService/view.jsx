...
const TermsOfService = () => (
  <div className="pb-2">
    <Container className="text-dark">
      <h1 className="mt-2 mb-2">Terms of Service</h1>
      <h2>Terms</h2>
      <p>
        By accessing the website at&nbsp;
        <a href="https://cms.quanda.dev">https://cms.quanda.dev</a>, you are agreeing to be
      ...
      <ol type="a">
        <li>
          ...
          or software) on Administrator&apos;s website for personal, non-commercial transitory
        ...
        <li>
          ...
          and may be terminated by Administrator at any time. Upon terminating your viewing of
      ...
      <ol type="a">
        <li>
          The materials on Administrator&apos;s website are provided on an &apos;as is&apos;
          basis. Administrator makes no warranties, expressed or implied, and hereby disclaims
        ...
        <li>
          Further, Administrator does not warrant or make any representations concerning the
      ...
      <h2>Limitations</h2>
      <p>
        In no event shall Administrator or its suppliers be liable for any damages (including,
        without limitation, damages for loss of data or profit, or due to business
        interruption) arising out of the use or inability to use the materials on
        Administrator&apos;s website, even if Administrator or a Administrator authorized
      ...
      <p>
        The materials appearing on Administrator&apos;s website could include technical,
        typographical, or photographic errors. Administrator does not warrant that any of the
        materials on its website are accurate, complete or current. Administrator may make
        changes to the materials contained on its website at any time without notice. However
        Administrator does not make any commitment to update the materials.
      </p>
      <h2>Links</h2>
      <p>
        Administrator has not reviewed all of the sites linked to its website and is not
        responsible for the contents of any such linked site. The inclusion of any link does
        not imply endorsement by Administrator of the site. Use of any such linked website is
        at the user&apos;s own risk.
      </p>
      <h2>Modifications</h2>
      <p>
        Administrator may revise these terms of service for its website at any time without
      ...
      <p>
        ...
        New York, NY and you irrevocably submit to the exclusive jurisdiction of the courts in
        that State or location.
      </p>
      <span>Terms of Use created with GetTerms.</span>
    </Container>
  </div>
);
